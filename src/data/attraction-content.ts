...
export const attractionExtras: Record<string, AttractionExtras> = {
  ...
  "temple-of-heaven": {
    ...
    faq: [
      ...
      { q: "What time does the Temple of Heaven open?", a: "The Temple of Heaven park opens daily at 6:00am and closes at 10:00pm (last entry 9:00pm). The main indoor halls (Hall of Prayer for Good Harvests, Echo Wall, Circular Mound Altar) open 8:00am-5:30pm in winter and 8:00am-6:00pm in summer, last entry 30 minutes before closing. Indoor halls are closed on Mondays." },
      { q: "Do I need to book Temple of Heaven tickets in advance?", a: "No — unlike the Forbidden City, Temple of Heaven tickets are sold walk-up at the gate (CNY 10-15 for park only, CNY 28-34 for through-ticket including the three main halls). No reservation needed. The easiest way is to buy at the south gate ticket window on arrival." }
    ]
  },
